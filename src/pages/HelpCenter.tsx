                            ...
                            <div className="relative flex items-center gap-2">
                                ...
                                {showLeftArrow && (
                                    <button
                                        ...
                                        className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#ffead4]/55 bg-[#5a392b]/92 text-[1.1rem] font-semibold text-[#ffead4] shadow-[0_0.75rem_1.6rem_rgba(0,0,0,0.32)] transition-all hover:border-[#ffead4]/85 hover:bg-[#5a392b]"
