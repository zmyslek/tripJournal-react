...
const policies: Record<string, Policy> = {
    privacy: {
        ...
        sections: [
            {
                heading: "Information stored by the app",
                body: [
                    "TripJournal stores your selected country statuses, such as visited, want to visit, and want to return, in your browser's local storage.",
                    "The app also stores your cookie notice choice in local storage so the notice does not keep reappearing."
                ]
            },
            {
                heading: "Location",
                body: [
                    "If your browser asks for location permission and you allow it, TripJournal uses your approximate coordinates to mark the country you appear to be in.",
                    "Your coordinates are kept in the current browser session state and are not saved by TripJournal to local storage."
                ]
            },
            {
            ...
            },
            {
                ...
                body: [
                    "You can clear TripJournal data by clearing this site's local storage in your browser settings.",
                    "You can block or revoke location permission through your browser's site permission controls."
                ]
            }
        ]
    },
        ...
        sections: [
            {
                ...
                body: [
                    "Cookie consent choice: stored under tripjournal:cookie-consent:v1.",
                    "Country status selections: stored under tripjournal:country-statuses:v1."
                ]
            },
            {
                heading: "Why it is stored",
                body: [
                    "The consent choice prevents the cookie notice from appearing after you answer it.",
                    "Country statuses let your travel map keep your selections when you return to the app from the same browser."
                ]
            },
            {
        ...
        sections: [
            {
                ...
                body: [
                    "TripJournal is provided as a travel planning and journaling interface. You may use it for personal, non-commercial purposes.",
                    "Do not misuse the app, interfere with its operation, attempt unauthorized access, or use it in a way that violates applicable law."
                ]
            },
            {
                heading: "Travel information",
                body: [
                    "Map outlines, country names, and location-based features are provided for convenience and may be incomplete or inaccurate.",
                    "Do not rely on TripJournal for legal, border, visa, safety, emergency, or official travel decisions."
                ]
            },
            {
            ...
            },
            {
                ...
                body: [
                    "The app is provided as is and may change, break, or become unavailable without notice.",
                    "To the fullest extent allowed by law, TripJournal is not liable for losses resulting from use of, or inability to use, the app."
                ]
            }
        ]
    },
        ...
        sections: [
            {
                ...
                body: [
                    "Core navigation uses links and buttons with accessible names.",
                    "Form controls for search, country statuses, map view, and filters use labels or aria labels."
                ]
            },
            {
            ...
            },
            {
                ...
                body: [
                    "Future improvements should include richer gallery captions, stronger reduced-motion handling, and more complete keyboard alternatives for highly visual controls.",
                    "If you maintain this app, review accessibility whenever new interactive features are added."
                ]
            }
        ]
    }
